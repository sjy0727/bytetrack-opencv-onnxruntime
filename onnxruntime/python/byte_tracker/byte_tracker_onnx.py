...
class ByteTrackerONNX(object):
    def __init__(self, args):
        ...
        self.local_features, self.local_features_ids  = load_registered_features('/Users/sunjunyi/PycharmProjects/bytetrack-opencv-onnxruntime/onnxruntime/python/byte_tracker/person_features')
